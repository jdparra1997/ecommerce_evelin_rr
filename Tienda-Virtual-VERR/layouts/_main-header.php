<header>
	<div class="logo-place"><a href="index.php"><img src="assets/logo_1.png"></a></div>
	<div class="search-place">
		<input type="text" id="idbusqueda" placeholder="Todo en accesorios tecnologicos" value="<?php if(isset($_GET['text'])){echo $_GET['text'];}else{echo '';} ?>">
